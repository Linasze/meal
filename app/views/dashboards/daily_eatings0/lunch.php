<div id="headingThree">
   <div class="card-header">
        <div class="row">
   <div class="col-md-2 col-2 text-center"> 12:00<br> Lunch</div>
   ...
   <div class="col-md-2 col-2 text-center mt-2"> <?php echo round($data['proteinsperservingUseEmptylunch']);?></div>
   <div class="col-md-2 col-2 text-center mt-2"> <?php echo round($data['carbsperservingUseEmptylunch']);?></div>
   <div class="col-md-1 col-1 text-center mt-2"> <?php echo round($data['fatsperservingUseEmptylunch']);?></div>
   <div class="col-md-1 col-1 text-center mt-2"> <?php echo round($data['caloriesperservingLunch']);?></div>
