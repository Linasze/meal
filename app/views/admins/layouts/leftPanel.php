...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="./"><img src="<?php echo URLROOT;?>/admin/images/logo.png" alt="Logo"></a>
...
<div id="main-menu" class="main-menu collapse navbar-collapse">
    ...
    <li class="active">
        ...
        <li class="active">
            <a href="<?php echo URLROOT;?>/admins/manageMeals"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
        </li>
        <h3 class="menu-title">UI elements</h3><!-- /.menu-title -->
        <li class="menu-item-has-children dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Do something</a>
            <ul class="sub-menu children dropdown-menu">
                <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo URLROOT;?>/admins/manageMeals">Manage meals</a></li>
        ...
        <li class="menu-item-has-children dropdown">
            ...
            <ul class="sub-menu children dropdown-menu">
                <li><i class="fa fa-table"></i><a href="<?php echo URLROOT;?>/ManageUsers/index">New Users</a></li>
                <li><i class="fa fa-table"></i><a href="tables-data.html">All Users</a></li>
           </ul>
        </li>
        <li class="menu-item-has-children dropdown">
