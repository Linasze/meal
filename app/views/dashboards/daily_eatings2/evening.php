<div id="headingSix">
    ...
    <div class="card-header">
     ...
     <img src="<?php echo URLROOT;?>/public/img/arrow-down.svg" height="15" weight="15">
       <font size="2"><?php echo $data['evening3Day']->title; ?></font>
     </button>
     </div>
...
<div class="col-12">Evening meal<br>Time: <?php echo date('h:i',strtotime($data['user_settings']->wake_up)) + 15 . ":00";?></div>
    <div class="col-12"><?php echo $data['evening3Day']->title; ?></div>
...
<div class="col-12">Recipe: <input type="image" src="<?php echo URLROOT;?>/public/img/eye-solid.svg" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix" height="25" width="25"></div>
     ...
     <div class="col-md-12 d-none d-md-block d-lg-none">
        ...
        <div class="col-md-12"><?php echo $data['evening3Day']->title; ?></div>
        <hr>
...
<?php if($product->id == $data['proteinEvening3day'][$i]): ?>
...
if(empty($product->use_id)){ 
    if(!empty($product->use_id)){
        if($product->id == $data['proteinEvening3day'][$i]){
            echo round($data['proteinsperservingUseEmptyevening']/2 * 100/ $product->protein).  " g". "<br>";
        } 
    }else{
 
        if(count($data['proteinEvening3day']) == 2 && empty($data['get_product1evening']->use_id)){
            if($product->id == $data['proteinEvening3day'][$i]){
                echo round($data['proteinsperservingUseEmptyevening']/2 * 100/ $product->protein).  " g". "<br>";
            }
            // Two products one with out use_id and one with use_is  
        }elseif(count($data['proteinEvening3day']) == 2 && !empty($data['get_product1evening']->use_id)){
            if($product->id == $data['proteinEvening3day'][$i]){
                echo round($data['proteinsperservingUseEmptyevening'] * 100/ $product->protein).  " g". "<br>";
            }
        }elseif(count($data['proteinEvening3day']) == 3 && !empty($data['get_product1evening']->use_id) && !empty($data['get_product2evening']->use_id)){
            if($product->id == $data['proteinEvening3day'][$i]){
                echo round($data['proteinsperservingUseEmptyevening'] * 100/ $product->protein).  " g". "<br>";
            }
        }elseif(count($data['proteinEvening3day']) == 3 && !empty($data['get_product2evening']->use_id)){
            if($product->id == $data['proteinEvening3day'][$i]){
                echo round($data['proteinsperservingUseEmptyevening']/2 * 100/ $product->protein).  " g". "<br>";
            }
        }elseif(count($data['proteinEvening3day']) == 4 && !empty($data['get_product3evening']->use_id)){
            if($product->id == $data['proteinEvening3day'][$i]){
                echo round($data['proteinsperservingUseEmptyevening'] * 100/ $product->protein).  " g". "<br>";
            }
        }else{
...
<?php if($product->id == $data['carbEvening3day'][$i]): ?>
<?php echo $product->title . " ";?> 
...
if(empty($product->use_id)){ 
    if(!empty($product->use_id)){
        if($product->id == $data['carbEvening3day'][$i]){
            echo round($data['carbsperservingUseEmptyevening']/2 * 100/ $product->carb).  " g". "<br>";
        } 
    }else{
 
        if(count($data['carbEvening3day']) == 2 && empty($data['getProduct1evening']->use_id)){
            if($product->id == $data['carbEvening3day'][$i]){
                echo round($data['carbsperservingUseEmptyevening']  * 100/ $product->carb).  " g". "<br>";
            }
            // Two products one with out use_id and one with use_is  
        }elseif(count($data['carbEvening3day']) == 2 && !empty($data['getProduct1evening']->use_id)){
            if($product->id == $data['carbEvening3day'][$i]){
                echo round($data['carbsperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }elseif(count($data['carbEvening3day']) == 3 && !empty($data['getProduct1evening']->use_id) && !empty($data['getProduct2evening']->use_id)){
            if($product->id == $data['carbEvening3day'][$i]){
                echo round($data['carbsperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }elseif(count($data['carbEvening3day']) == 3 && !empty($data['getProduct2evening']->use_id)){
            if($product->id == $data['carbEvening3day'][$i]){
                echo round($data['carbsperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }elseif(count($data['carbEvening3day']) == 4 && !empty($data['getProduct3evening']->use_id)){
            if($product->id == $data['carbEvening3day'][$i]){
                echo round($data['carbsperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }else{
...
<?php if($product->id == $data['fatEvening3day'][$i]): ?>
<?php echo $product->title . " ";?> 
...
if(empty($product->use_id)){ 
    if(!empty($product->use_id)){
        if($product->id == $data['fatEvening3day'][$i]){
            echo round($data['fatsperservingUseEmptyevening']/2 * 100/ $product->fat).  " g". "<br>";
        } 
    }else{
 
        if(count($data['fatEvening3day']) == 2 && empty($data['getPro1evening']->use_id)){
            if($product->id == $data['faLuncht'][$i]){
                echo round($data['fatsperservingUseEmptyevening']  * 100/ $product->fat).  " g". "<br>";
            }
            // Two products one with out use_id and one with use_is  
        }elseif(count($data['fatEvening3day']) == 2 && !empty($data['getPro1evening']->use_id)){
            if($product->id == $data['fatEvening3day'][$i]){
                echo round($data['fatsperservingUseEmptyevening'] * 100/ $product->fat).  " g". "<br>";
            }
        }elseif(count($data['fatEvening3day']) == 3 && !empty($data['getPro1']->use_id) && !empty($data['getPro2evening']->use_id)){
            if($product->id == $data['fatEvening3day'][$i]){
                echo round($data['fatsperservingUseEmptyevening'] * 100/ $product->fat).  " g". "<br>";
            }
        }elseif(count($data['fatEvening3day']) == 3 && !empty($data['getPro2evening']->use_id)){
            if($product->id == $data['fatEvening3day'][$i]){
                echo round($data['fatsperservingUseEmptyevening'] * 100/ $product->fat).  " g". "<br>";
            }
        }elseif(count($data['fatEvening3day']) == 4 && !empty($data['getPro3evening']->use_id)){
            if($product->id == $data['fatEvening3day'][$i]){
                echo round($data['fatsperservingUseEmptyevening'] * 100/ $product->fat).  " g". "<br>";
            }
        }else{
...
<?php if($product->id == $data['otherEvening3day'][$i]): ?>
<?php echo $product->title . " ";?> 
...
if(empty($product->use_id)){ 
    if(!empty($product->use_id)){
        if($product->id == $data['otherEvening3day'][$i]){
            echo round($data['othersperservingUseEmptyevening']/2 * 100/ $product->carb).  " g". "<br>";
        } 
    }else{
 
        if(count($data['otherEvening3day']) == 2 && empty($data['getPr1evening']->use_id)){
            if($product->id == $data['otherEvening3day'][$i]){
                echo round($data['othersperservingUseEmptyevening']/2 * 100/ $product->carb).  " g". "<br>";
            }
            // Two products one with out use_id and one with use_is  
        }elseif(count($data['otherEvening3day']) == 2 && !empty($data['getPr1evening']->use_id)){
            if($product->id == $data['otherEvening3day'][$i]){
                echo round($data['othersperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }elseif(count($data['otherEvening3day']) == 3 && !empty($data['getPr1evening']->use_id) && !empty($data['getPr2evening']->use_id)){
            if($product->id == $data['otherEvening3day'][$i]){
                echo round($data['othersperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }elseif(count($data['otherEvening3day']) == 3 && !empty($data['getPr2evening']->use_id)){
            if($product->id == $data['otherEveninglunch'][$i]){
                echo round($data['othersperservingUseEmptyevening']/2 * 100/ $product->carb).  " g". "<br>";
            }
        }elseif(count($data['otherEvening3day']) == 4 && !empty($data['getPr3evening']->use_id)){
            if($product->id == $data['otherEvening3day'][$i]){
                echo round($data['othersperservingUseEmptyevening'] * 100/ $product->carb).  " g". "<br>";
            }
        }else{
...
<div class="col-md-8 col- text-left">
    <h5>Recipe</h5>
    <font size="2">
        <?php echo $data['evening3Day']->recipe; ?>
    </font>
</div>
</div>
</div>
